...
def get_readable_time(seconds: int) -> str:
    ...
    while count < 4:
        count += 1
        remainder, result = /vmod(seconds, 60) if count < 3 else divmod(seconds, 24)
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/91825bb09d851ac589703.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Sriki 𝚁𝚘𝚋𝚘𝚝*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜e", url="t.me/Srikibot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="Owner💝", https://t.me/Srikanth_36"),
        InlineKeyboardButton(
            text="join", url=f"https://t.me/we_all_are_best_friends"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url = https://t.me/Sriki_music_bot_support"),
    ], 
